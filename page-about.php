...
<p><i class="fa fa-graduation-cap"></i> Best Coding Score management template for ever.</p>
</div>
...
<div class="logo">
<a class="navbar-brand" href="index.php"><img src="images/online-judge-logo.jpg" width="50" height="50" alt=""></a>
</div>
</div>
<div class="navbar-collapse collapse">
<ul class="nav navbar-nav">
<li><a href="index.php">HOME</a></li>
<li><a class="active" href="page-about.php">HackerRank</a></li>
<li><a href="page-codechef.php">Codechef</a></li>
<li><a href="page-codeforce.php">CodeForces</a></li>
<li><a href="page-spoj.php">SPOJ</a></li>
</ul>
<ul class="nav navbar-nav navbar-right">
<li><a class="btn btn-primary" href="course-login1.php"><i class="fa fa-sign-in"></i> Register/Signin Now</a></li>
</ul>
</div>
</div>
</div>
...
<img src="images\hackerrank1.png" alt="" class="img-responsive">
</div>
<div class="item">
<img src="images\hackerrank2.jpg" alt="" class="img-responsive">
</div>
</div>
...
<h3><strong>Welcome to HackerRank</strong></h3>
<hr>
</div>
<p><h4>HackerRank is a place where programmers from all over the world come together to solve problems in a wide range of Computer Science domains such as algorithms, machine learning, or artificial intelligence, as well as to practice different programming paradigms like functional programming.</h4></p>
<center><h2><a href="https://www.hackerrank.com/access-account/" bg-color="Blue">hackerrank.com</a></h2></center></div>
</div>
</div>
</div>
