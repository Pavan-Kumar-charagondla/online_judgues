...
<img src="images\codechef1.jpg" alt="" class="img-responsive">
</div>
<div class="item">
<img src="images\codechef2.jpg" alt="" class="img-responsive">
</div>
</div>
...
<h3><strong>Welcome to CodeChef</strong></h3>
<hr>
</div>
<p><h4>CodeChef was created as a platform to help programmers make it big in the world of algorithms, computer programming, and programming contests. It hosts three featured contests every month (Long Challenge, CookOff, LunchTime & Starters) and gives away prizes and goodies to the winners as encouragement.</h4></p>
<center><h2><a href="https://www.codechef.com/teams/view/login">Codechef.com</a></h2></center></div>
</div>
</div>
</div>
