...
<title>OnlineJUDGES | Coding Score Management System HTML Template</title>
...
<a href="index-2.html"><img src="images\online-judge-logo.jpg" width="100" height="100" alt=""></a>
</div>
...
<input type="email" name="email" id="email" tabindex="1" class="form-control" placeholder="Vardhaman mail" value="" required>
</div>
<div class="form-group">
...
<form id="register-form" action="reg.php" method="post" role="form" style="display: none;">
<div class="form-group">
<input type="text" name="name" id="name" tabindex="1" class="form-control" placeholder="name" value="" required>
</div>
<div class="form-group">
<input type="text" name="Rollno" id="rollno" tabindex="1" class="form-control" placeholder="RollNo" value="" required>
</div>
<div class="form-group">
<input type="text" name="Branch" id="branch" tabindex="1" class="form-control" placeholder="Branch" value="" required>
</div>
<div class="form-group">
<input type="text" name="passout" id="passoutyear" tabindex="1" class="form-control" placeholder="Passoutyear" value="" required>
</div>
<div class="form-group">
<input type="text" name="Hackerrank" id="hackerrankusername" tabindex="1" class="form-control" placeholder="Hackerrank Username" value="" required>
</div>
<div class="form-group">
<input type="text" name="CodeChef" id="codechefusername" tabindex="1" class="form-control" placeholder="CodeChef Username" value="" required>
</div>
<div class="form-group">
<input type="text" name="Codeforces" id="codeforcesusername" tabindex="1" class="form-control" placeholder="Codeforces Username" value="" required>
</div>
<div class="form-group">
<input type="text" name="Spoj" id="spojusername" tabindex="1" class="form-control" placeholder="Spoj Username" value="" required>
</div>
<div class="form-group">
...
<div class="row">
<div class="col-sm-12">
<button type="submit" class="form-control btn btn-default btn-block" name="reg">Register an Account</button>
</div>
</div>
</div>
</form>
